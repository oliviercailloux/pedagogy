...
%Do not use the displaymath environment: use equation. Do not use the eqnarray or eqnarray* environments: use align(*). They lead to incorrect spacing. (See l2tabu or amsldoc.) 
%Use \centering or the center environment for additional space.
